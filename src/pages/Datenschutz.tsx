    ...
    >
      <Container maxWidth="md">
        ...
        <Box sx={{ color: 'text.secondary' }}>
          ...
          <h3>Hinweis zur verantwortlichen Stelle</h3> <p>Die verantwortliche Stelle f&uuml;r die Datenverarbeitung auf dieser Website ist:</p> <p>Patrick Brösamle<br />
          Blumenstr. 91<br />
          01307 Dresden</p>

          <p>
          Email: <Link href="mailto:patrick@broesamle.dev" sx={{ color: '#D0BCFF' }}>patrick@broesamle.dev</Link></p>
