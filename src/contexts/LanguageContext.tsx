...
const translations: Record<Language, Translations> = {
  de: {
    ...
    heroTitle: 'Verpasse nie wieder einen Gutschein',
    heroSubtitle: 'CouponTresor organisiert all deine Coupons mit KI-gestützter Extraktion. Mach ein Foto und wir erledigen den Rest. Verfolge Ablaufdaten, teile und finde geteilte Gutscheine, verdiene Belohnungen und spare mühelos Geld.',
    downloadForAndroid: 'Für Android herunterladen',
    learnMore: 'Mehr erfahren',
    freeToUse: 'Kostenlos nutzbar',
    poweredOCR: 'gestützte Erkennung',
    ads: 'Werbung / Pop-ups',
    ...
    featureAIOCR: 'KI-Analyse',
    featureAIOCRDesc: 'Mach ein Foto deines Gutscheins, lade ein Bild hoch, teile einen Text oder leite eine E-Mail weiter und lass die KI alle Details extrahieren.',
    featureReminders: 'Ablauf-Erinnerungen',
    featureRemindersDesc: 'Lass niemals einen Gutschein ungenutzt ablaufen. Erhalte intelligente Benachrichtigungen bevor deine Gutscheine ablaufen.',
    featureBarcode: 'Barcode & QR-Support',
    featureBarcodeDesc: 'Umfassende Unterstützung für Barcode- und QR-Code-Gutscheine. Scanne an der Kasse direkt von deinem Handy.',
    featureSharing: 'Gutschein-Teilen',
    featureSharingDesc: 'Teile nicht-personengebundene Gutscheine mit Freunden, Familie oder der Community. Verdiene Belohnungen durch das Teilen.',
    featureOrganization: 'Smarte Organisation',
    featureOrganizationDesc: 'Filtere und durchsuche deine, die Gutscheine deiner Freunde und der Community nach Shop, Produkt, Code. Finde sofort was du brauchst.',
    featureEmail: 'E-Mail-Integration',
    featureEmailDesc: 'Sammle automatisch Gutscheine aus deinen E-Mails. Nutze Weiterleitung oder abonniere Newsletter direkt mit deiner CouponTresor-E-Mail.',
    featureCloudSync: 'Cloud-Synchronisierung',
    featureCloudSyncDesc: 'Speichere deine Gutscheine in der sicheren Cloud. Synchronisiere sie geräteübergreifend. Verliere niemals deine Ersparnisse beim Handywechsel.',
    featurePrivacy: 'Datenschutz',
    featurePrivacyDesc: 'Datenspeicherung in Deutschland, KI-Verarbeitung innerhalb der EU oder vollständig auf deinem Gerät – du entscheidest über deine Daten.',
    ...
    stepCaptureDesc: 'Mach ein Foto deines Coupons oder importiere Bilder aus der Galerie.',
    ...
    footerPrivacy: 'Datenschutz (Web)',
    footerPrivacyApp: 'Datenschutz (App)',
    footerTerms: 'AGB',
    footerEmailTerms: 'E-Mail Feature AGB',
  ...
  en: {
    ...
    featureAIOCR: 'AI Analysis',
    featureAIOCRDesc: 'Snap a photo of your coupon, upload an image, share a text or forward an email and let AI extract all details.',
    ...
    featureBarcode: 'Barcode & QR Support',
    featureBarcodeDesc: 'Full support for barcode and QR code coupons. Scan the coupon code at checkout directly from your phone.',
    featureSharing: 'Coupon Sharing',
    featureSharingDesc: 'Share non-personal coupons with friends, family or the community. Earn rewards when your shared coupons are used.',
    featureOrganization: 'Smart Organization',
    featureOrganizationDesc: 'Filter and search your, your friends and community coupons by shop, product, code. Find what you need instantly.',
    featureEmail: 'Email Integration',
    featureEmailDesc: 'Automatically collect coupons from your emails. Use forwarding or subscribe directly to newsletter with your CouponTresor email.',
    featureCloudSync: 'Cloud Sync',
    featureCloudSyncDesc: 'Save your coupons to the secure cloud. Sync them across devices. Never lose your savings when switching phones.',
    featurePrivacy: 'Privacy',
    featurePrivacyDesc: 'Data storage in Germany, AI processing within the EU, or completely local on your device – you control your data.',

    // How It Works
    howItWorks: 'How It Works',
    howItWorksSubtitle: 'Four simple steps to organize your coupons and start saving money today.',
    stepCapture: 'Capture',
    stepCaptureDesc: 'Take a photo of your coupon or import images from your gallery.',
    ...
    footerLegal: 'Legal',
    footerSupport: 'Support',
    footerPrivacy: 'Privacy Policy (Web)',
    footerPrivacyApp: 'Privacy Policy (App)',
    footerTerms: 'Terms of Service',
    footerEmailTerms: 'Email Feature Terms',
...
export const LanguageProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  const [language, setLanguage] = useState<Language>(() => {
    // 1. Check URL parameter (e.g., ?lang=de or ?lang=en)
